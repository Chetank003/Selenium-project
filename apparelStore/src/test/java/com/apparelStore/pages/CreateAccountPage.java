...
public class CreateAccountPage {
	...
	@FindBy(id=ObjectRepo.createAccount.firstName_id)
	public WebElement firstName;
	
	@FindBy(id=ObjectRepo.createAccount.lastName_id)
	public WebElement lastName;
	
	@FindBy(id=ObjectRepo.createAccount.password_id)
	public WebElement password;
	
	@FindBy(id=ObjectRepo.createAccount.addressLine1_id)
	public WebElement addressLine1;
	
	@FindBy(id=ObjectRepo.createAccount.addressCity_id)
	public WebElement city;
	
	@FindBy(xpath=ObjectRepo.createAccount.dropDownStates_xpath)
	public WebElement state;
	
	@FindBy(id=ObjectRepo.createAccount.addressPostalCode_id)
	public WebElement postalCode;
	
	@FindBy(id=ObjectRepo.createAccount.dropDownCountry_id)
	public WebElement country;
	
	@FindBy(id=ObjectRepo.createAccount.mobilePhone_id)
	public WebElement phoneNumber;
	
	@FindBy(id=ObjectRepo.createAccount.registerBtn_id)
	public WebElement registerBtn;
	
	@FindBy(className=ObjectRepo.createAccount.alertMessage_name)
